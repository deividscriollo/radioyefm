...
<body id="page-top">
    ...
    <header class="video">
        ...
        <div class="intro-content">
            ...
            <div class="col-sm-4">
                <a href="esmeraldas/">
                    <img src="assets/img/Esmeraldas.png" width="80%">
                <h3>Esmeraldas</h3>
                <hr class="colored"></a>
            </div>
            <div class="col-sm-4">
                <a href="imbabura/"><img src="assets/img/Imbabura.png" width="80%">
                <h3>Imbabura</h3>
                <hr class="colored"></a>
            </div>
            <div class="col-sm-4">
                <a href="santodomingo/"><img src="assets/img/snto_domingo.png" width="80%">
                <h3>Santo Domingo</h3>
                <hr class="colored"></a>
            </div>
        </div>
...
<!-- Mirrored from themes.startbootstrap.com/vitality-v1.3.6/video.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Dec 2015 21:42:42 GMT -->
</html>
