...
<!-- Inicio de la Primera noticia -->
              <article class="blog-row clearfix">
                  <div class="blog-left">
                    <div class="vc_anim vc_anim-slide"> <a href="portfolio-single-project.php" class="vc_preview"> <img alt="example image" src="img/noticias/noticia1.jpg"  /> </a>
                      <div class="vc_hover">
                  ...
                  <div class="blog-right clearfix">
                    <h3> <a href="blog-single.php"> Noticia 1 </a> </h3>
                    <span class="date"> 04 Febrero 2016</span> <span class="comments"> </span> <span class="taxonomy"> <i class="fa fa-tags"> </i> </span>
          ...
          <div class="col-sm-4">
            <!-- Inicio de la Primera noticia -->
              <article class="blog-row clearfix">
                  ...
                  <div class="blog-right clearfix">
                    <h3> <a href="blog-single.php"> Noticia 2 </a> </h3>
                    <span class="date"> 04 Febrero 2016</span> <span class="comments"> </span> <span class="taxonomy"> <i class="fa fa-tags"> </i> </span>
                    <div class="description">
                      <p> El banco de inversión Bank of America se encuentra a la espera de que el Gobierno venezolano...
                      <br> 
...
<!-- Inicio de la Tercera noticia -->
              <article class="blog-row clearfix">
                  ...
                  <div class="blog-right clearfix">
                    <h3> <a href="blog-single.php"> Noticia 3 </a> </h3>
                    <span class="date"> 04 Febrero 2016</span> <span class="comments"> </span> <span class="taxonomy"> <i class="fa fa-tags"> </i> </span>
                    <div class="description">
                      <p> El banco de inversión Bank of America se encuentra a la espera de que el Gobierno venezolano...
                      <br> 
...
<!-- Fin de la Tercera noticia -->
          </div>
        </div>
        <br>
        <div class="row">
          <h5 class="vc_widget-title text-center">Invitados Especiales</h5>
          <br>
          <div class="col-sm-4"> 
