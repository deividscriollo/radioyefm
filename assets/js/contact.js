...
(function() {
  ...
  this.AudioPlayerUI = (function() {
    ...
    AudioPlayerUI.prototype.setEl = function(el) {
      ...
      this.$backButton = this.$el.find(".ion-skip-backward");
      this.$nextButton = this.$el.find(".ion-skip-forward");
  ...
  this.audioPlayer = new AudioPlayerUI({
    ...
    songs: [
      {
        image: "assets/img/oye-logo.jpg",
        name: "Oye, Lo que te gusta",
        srcs: [
          {
            src: "http://giss.tv:8001/oye971.mp3",
            type: "audio/mp3"
          }
        ]
      }
