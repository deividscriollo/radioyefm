app.controller('tipoCtrl',
        function ($scope, $http, $modal, $log, $filter, ngTableParams, MessageBox) {

            cargar_tabla();

            function cargar_tabla() {
                $http.get(appOye_fm.urlGetTipo).success(function (result, status) {
                    $scope.searchText = '';
            ...
            function filter_by_fields(data) {
                ...
                if (text) {
                    ...
                    return !text || reg_exp.test(data.nombre) || reg_exp.test(data.observaciones);
                }
                return true;
            }
            ...
            $scope.showModal = function (fila) {
                var modalInstance = $modal.open({
                    templateUrl: appOye_fm.urlModal + '/modalTipoVendedor.html',
            ...
            $scope.eliminar = function (id) {
                var mbox = MessageBox.confirm('Esta seguro de eliminar este dato?', 'Eliminar Tipo vendedor');
