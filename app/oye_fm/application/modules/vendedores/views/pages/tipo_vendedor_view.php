<script type="text/javascript">
    var appOye_fm = {};
    appOye_fm.urlGetTipo = '<?= base_url() . 'vendedores/tipo_vendedor/get_tipo_vendedores' ?>';
    appOye_fm.urlProcesar = '<?= base_url() . 'vendedores/tipo_vendedor/procesar' ?>';
    appOye_fm.urlEliminar = '<?= base_url() . 'vendedores/tipo_vendedor/delete' ?>';
    appOye_fm.urlRepetido = '<?= base_url() . 'vendedores/tipo_vendedor/validar_repetido' ?>';
    appOye_fm.urlModal = '<?= base_url() . 'application/modules/vendedores/views/modals' ?>';
</script>
<script src="<?php echo base_url(); ?>application/modules/vendedores/js/tipo_vendedor.js"></script>
</div>
                    ...
                    <div class="table-responsive">
                        <table ng-table="tableParams" class="table table-bordered table-striped table-condensed table-hover">
                            <tr style="background:white;" ng-repeat="cliente in $data| filter:searchText">
                                ...
                                <td data-title="'Tipo Vendedor'" sortable="'empresa'">
