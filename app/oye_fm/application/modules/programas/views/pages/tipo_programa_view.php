<script type="text/javascript">
    var appOye_fm = {};
    appOye_fm.urlGetTipo = '<?= base_url() . 'programas/tipo_programa/get_tipo_programas' ?>';
    appOye_fm.urlProcesar = '<?= base_url() . 'programas/tipo_programa/procesar' ?>';
    appOye_fm.urlEliminar = '<?= base_url() . 'programas/tipo_programa/delete' ?>';
    appOye_fm.urlRepetido = '<?= base_url() . 'programas/tipo_programa/validar_repetido' ?>';
    appOye_fm.urlModal = '<?= base_url() . 'application/modules/programas/views/modals' ?>';
</script>
<script src="<?php echo base_url(); ?>application/modules/programas/js/tipo_programa.js"></script>
</div>
<div class="main-content" ng-controller="tipoCtrl">
    <div class="main-content-inner">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Tipo Programa</li>
            </ul><!-- /.breadcrumb -->
        </div>
                    ...
                    <div class="table-responsive">
                        <table ng-table="tableParams" class="table table-bordered table-striped table-condensed table-hover">
                            <tr style="background:white;" ng-repeat="cliente in $data| filter:searchText">
                                ...
                                <td data-title="'Tipo Programa'" sortable="'nombre'">
                                    <span>{{cliente.nombre}}</span>
                                </td>

                                <td data-title="'Categoria'" sortable="'categoria'">
