...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Recuperar Contraseña - Oye Fm</title>
                    ...
                    <div class="col-sm-10 col-sm-offset-1">
                        <div class="login-container">
                            ...
                            <div class="position-relative">
                                ...
                                <div id="forgot-box" class="forgot-box widget-box no-border visible"> <!-- forgot-box -->
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <form name="resetForm" action="<?php echo base_url('usuarios/auth/forgot_password'); ?>" method="post" novalidate >
                                                <fieldset>
                                                    <div class="red"><?php echo $this->dx_auth->get_auth_error(); ?> </div>
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <input type="email" class="form-control" placeholder="Email" name="login" ng-model="email_reset" ng-minlength="9" ng-maxlength="25" ng-pattern="/^[^\s@]+@[^\s@]+\.[^\s@]{2,}$/" required/>
                                                            <i class="ace-icon fa fa-envelope"></i>
                                                        </span>
                                                        <div ng-show="resetForm.login.$error.minlength" class="red">El campo Email es muy pequeño, minimo 9 caracteres.</div>
                                                        <div ng-show="resetForm.login.$error.maxlength" class="red">El campo Email es muy grande, maximo 25 caracteres.</div>
                                                        <div ng-show="resetForm.login.$invalid && !resetForm.login.$pristine" class="red">Ingrese un email valido.</div>
                                                        <!--<div ng-show="resetForm.login.$invalid && !resetForm.email_reset.$pristine" class="red">Ingrese un email valido.</div>-->
                                                        <div class="red"><?php echo form_error('login'); ?> </div>
                                                    </label>

                                                    <div class="clearfix">
                                                        <button type="submit" class="width-35 pull-right btn btn-sm btn-danger" ng-disabled="resetForm.$invalid">
                                                            <i class="ace-icon fa fa-lightbulb-o"></i>
                                                            <span class="bigger-110">Enviarme !</span>
                                                        </button>
                                                    </div>
                                                </fieldset>
                                            </form>
