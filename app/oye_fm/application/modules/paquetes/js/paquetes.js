app.controller('paqueteCtrl',
        function ($scope, $http, $modal, $log, $filter, ngTableParams, MessageBox) {

            cargar_tabla();

            function cargar_tabla() {
                $http.get(appOye_fm.urlGetPaquetes).success(function (result, status) {
                    $scope.searchText = '';
            ...
            $scope.showModal = function (fila) {
                var modalInstance = $modal.open({
                    templateUrl: appOye_fm.urlModal + '/modalPaquete.html',
            ...
            $scope.eliminar = function (id) {
                var mbox = MessageBox.confirm('Esta seguro de eliminar este dato?', 'Eliminar Paquete');
