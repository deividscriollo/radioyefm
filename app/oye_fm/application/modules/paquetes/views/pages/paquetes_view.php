<script type="text/javascript">
    var appOye_fm = {};
    appOye_fm.urlGetPaquetes = '<?= base_url() . 'paquetes/paquetes/get_paquetes' ?>';
    appOye_fm.urlProcesar = '<?= base_url() . 'paquetes/paquetes/procesar' ?>';
    appOye_fm.urlEliminar = '<?= base_url() . 'paquetes/paquetes/delete' ?>';
    appOye_fm.urlRepetido = '<?= base_url() . 'paquetes/paquetes/validar_repetido' ?>';
    appOye_fm.urlModal = '<?= base_url() . 'application/modules/paquetes/views/modals' ?>';
</script>
<script src="<?php echo base_url(); ?>application/modules/paquetes/js/paquetes.js"></script>
</div>
<div class="main-content" ng-controller="paqueteCtrl">
                    ...
                    <div class="table-responsive">
                        <table ng-table="tableParams" class="table table-bordered table-striped table-condensed table-hover">
                            <tr style="background:white;" ng-repeat="cliente in $data| filter:searchText">
                                ...
                                <td data-title="'Paquete'" sortable="'nombre'">
