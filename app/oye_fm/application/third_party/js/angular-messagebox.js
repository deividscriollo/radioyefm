...
(function () {
    ...
    angular
            .module('angular-messagebox')
            .constant('Constants', {
                defaultErrorHeader: 'header error!',
                defaultErrorMsg: 'mesnaje',
                defaultNotifyHeader: 'header noti:',
                defaultNotifyMsg: 'msj noty',
                defaultConfirmHeader: 'header confir',
                defaultConfirmMsg: 'msj confirm',
...
(function () {
    ...
    function ErrorMsgBoxCtrl($scope, $sce, $modalInstance, data, Constants) {
        ...
        $scope.icon = (angular.isDefined(data.fa) && angular.equals(data.fa, true)) ? 'fa fa-warning' : 'glyphicon glyphicon-ban-circle';
    ...
    function ConfirmMsgBoxCtrl($scope, $sce, $modalInstance, data, Constants) {
        ...
        $scope.icon = (angular.isDefined(data.fa) && angular.equals(data.fa, true)) ? 'halflings-icon ok' : 'glyphicon glyphicon-ok-sign';
    ...
    function NotifyMsgBoxCtrl($scope, $sce, $modalInstance, data, Constants) {
        ...
        $scope.icon = (angular.isDefined(data.fa) && angular.equals(data.fa, true)) ? 'fa fa-info' : 'glyphicon glyphicon-ok-sign';
...
angular.module("angular-messagebox").run(["$templateCache", function ($templateCache) {
        $templateCache.put("confirm.tpl.html", "<div class=\"modal-header dialog-header-confirm\">\r\n    <button type=\"button\" class=\"close\" ng-click=\"no()\">&times;</button>\r\n    <h4 class=\"modal-title\">\r\n        <span ng-class=\"icon\"></span>\r\n        <span ng-bind-html=\"header\"></span>\r\n    </h4>\r\n</div>\r\n<div class=\"modal-body\" ng-bind-html=\"msg\"></div>\r\n<div class=\"modal-footer\">\r\n    <button type=\"button\" class=\"btn btn-primary\" ng-click=\"yes()\">Aceptar</button>\r\n    <button type=\"button\" class=\"btn btn-warning\" ng-click=\"no()\">Cancelar</button>\r\n</div>");
