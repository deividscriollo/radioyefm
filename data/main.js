...
var app = angular.module('dcApp').controller('homeCtrl', function ($scope, service) {
    ...
    $('#btn_imbabura').click(function(){
        window.location.replace("imbabura/");
    });

    $('.close-btn').click(function(){
        var att = $( "#btn_play_esmeraldas").attr('class');
        var vec = att.split(' ');
        var res = $.inArray('ion-pause', vec); //devuelve 2
        if (res == 2) {
            $( "#btn_play_esmeraldas").trigger( "click" );
        }
    });
